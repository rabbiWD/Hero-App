...
const Banner = () => {
    return (
        <section>
            <div>
                <h1 className='text-7xl font-medium text-center'>We Build <br/> <span>Productive</span> Apps</h1>
                ...
                <div className='text-center space-x-4 mt-6'>
                    <button className='btn font-bold'><FaGooglePlay></FaGooglePlay> Google Play</button>
                    <button className='btn font-bold'><FaAppStoreIos></FaAppStoreIos> App Store</button>
                </div >
                <div>
