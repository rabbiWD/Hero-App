...
const Banner = () => {
    return (
        <section>
            <div>
                <h1 className='text-4xl md:text-7xl font-bold text-center'>We Build <br/> <span className='text-[#632ee3] '>Productive</span> Apps</h1>
                <p className='text-sm md:text-base mt-4 text-center text-gray-500 font-normal'>At HERO.IO, we craft innovative apps designed to make everyday life simpler, smarter, and more <br /> exciting. Our goal is to turn your ideas into digital experiences that truly make an impact. </p>
            ...
            <div className='bg-linear-to-r from-[#632ee3] to-[#9f62f2] text-white font-semibold text-center'>
                ...
                <div className='flex flex-col md:flex-row  md:justify-evenly md:items-center mt-7 pb-12'>
                    <div className='mt-2 md:mt-0 lg:mt-0'>
                        ...
                        <h1 className='text-5xl md:text-6xl font-extrabold'>26.9M</h1>
